  ...
  return (
    <div className="w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-[#fff9f6] m-2">
      ...
      <div className="flex items-center justify-center  gap-6">
        {showSearch? <GiSkullCrossedBones size={25} className="text-[#ff4d2d] md:hidden" onClick={()=>setShowSearch(false)} />:<MdOutlineSearch size={25} className="text-[#ff4d2d] md:hidden" onClick={()=>setShowSearch(true)}/>}
